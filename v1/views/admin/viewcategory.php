...
<div id="page-wrapper">
  <div class="graphs">
    <h3 class="blank1">Categories</h3>
    <a href="addcat"><i class="fa fa-plus-square"></i>Add New Category</a>
      <div class="xs tabls">
              ...
              <div class="form-group">
                   <div class="col-md-3">
                     <div class="input-icon right spinner">
                       <input id="search" onkeyup="searchQuery(2)" class="form-control1" type="text" placeholder="Search">
                     </div>
                   </div>
                   ...
                   <div class="col-md-3">
                     <div class="input-icon right spinner">
                       <p>
                         <span>
                           <select class="" name="" id="sort" onchange="sortRecord(2)">
                   ...
                   <div class="col-md-3">
                       <div class="input-icon right spinner">
                          <p>Show
                           <span>
                           <select class="" name="" id="limit" onchange="filterLimit(2)">
...
<script type="text/javascript">loadData(1, '', 2)</script>
