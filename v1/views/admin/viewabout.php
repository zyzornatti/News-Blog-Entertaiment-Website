               ...
               <div class="form-group">
                    <div class="col-md-3">
                       <div class="input-icon right spinner">
                         <input id="search" onkeyup="searchQuery(6)" class="form-control1" type="text" placeholder="Search">
                        </div>
                     </div>
                     ...
                     <div class="col-md-3">
                       <p id="sort"></p>
                         ...
                         <p>Show
                         <span>
             						<select class="" name="" id="limit" onchange="filterLimit(6)">
...
<script type="text/javascript">loadData(1, '', 6)</script>
