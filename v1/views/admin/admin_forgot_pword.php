				...
				<div class="graphs">
					<div class="sign-in-form">
						<div class="sign-in-form-top">
							<p><span>Admin Reset Password</span></p>
						</div>
						<div class="signin">
							...
							<form id="signupform" action="" method="post">
								 <div id="reset-response" style="visibility:hidden" class="alert alert-danger" role="alert"></div>
								<div class="log-input">
									<div class="log-input-left">
									   <input type="text" class="user" id="email" placeholder="Enter Your Email" required/>
									</div>
									<div class="clearfix"> </div>
								</div>

								<input type="button" onclick="adminForgotPassword();" class='btn btn-success' id="admsubmit" value="Reset Password">
